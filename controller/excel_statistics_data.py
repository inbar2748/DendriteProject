...
def excel_statistics_data(filepath,
    ...
    with open(f'{filepath}/{imagename}.csv', 'w') as file:
        ...
        file_csv.writerow(['Image name',
                           'Gui parameter value: p_threshold1',
                           'Gui parameter value: min distance to merge',
                           'Gui parameter value: min angle to merge',
                           'Identified numbers of lines:',
                           'Random simulation classification:',
                           s_col_name,
